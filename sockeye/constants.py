...
LAST_ALIGNMENT_NAME = "last_alignment"
...
INFERENCE_ARG_REFERENCE_LONG = "--reference"
INFERENCE_ARG_REFERENCE_SHORT = "-r"
...
UNALIGNED_JUMP_LABEL = NUM_ALIGNMENT_JUMPS -1
UNALIGNED_SOURCE_INDEX = -1
MAX_JUMP = 20
MAX_COVERAGE = 4
